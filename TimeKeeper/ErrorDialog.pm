package TimeKeeper::ErrorDialog;

# This is a copy of the Tk::ErrorDialog that does not work (It does not display
# the error dialog and gives a "Background Error: window ".errordiaog.dialog"
# was deleted before its visibility changed at C:/Perl/site/lib/Tk/Widget.pm
# line 996."
# I think this is caused by making the dialog box a child of the stacktrace
# dialog box, which is withdrawn. Therefore showing the child has no effect
# since its parent is still withdrawn.
# The fix is to make the error dialog ($dr) a child of the MainWindow ($mw)
# instead of of the ErrorDialog ($cw) widget in the Populate() method.
#
# See also http://osdir.com/ml/lang.perl.tk/2004-11/msg00014.html and
# http://osdir.com/ml/lang.perl.tk/2004-11/msg00015.html.
